...
There has been quite a bit of work focused on the detection of threats in a data set of Dutch tweets \cite{nellngram2013,nellshallow2013}, which consists of a collection of 5000 threatening tweets collected by a website. In addition, a large number of random tweets were collected for development and testing. %% A set of 2.3 million random tweets was used
...
, but do not go into detail about the methods used to construct these patterns%% , stating that the researchers relied on their
