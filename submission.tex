...
Figure~\ref{fig:comments} provides some examples of comments from the corpus. The first line is the annonymized username, and the subsequent lines are the sentences of the comment. %% An empty line indicates the end of a comment.
