...
% Features for threat detection of user-generated text?
...
different representations of linguistic context and feature backoff. Our results show that combinations of lexical features outperform the use of more complex linguistic features for this task.
\end{abstract}
